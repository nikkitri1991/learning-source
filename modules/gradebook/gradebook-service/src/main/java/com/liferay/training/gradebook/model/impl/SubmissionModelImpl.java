...
public class SubmissionModelImpl
	...
	public Submission cloneWithOriginalValues() {
		...
		submissionImpl.setUuid(this.<String>getColumnOriginalValue("uuid_"));
		...
		submissionImpl.setSubmissionText(
			this.<String>getColumnOriginalValue("submissionText"));
	...
	static {
		...
		columnBitmasks.put("submissionId", 4L);
		...
		columnBitmasks.put("studentId", 512L);

		columnBitmasks.put("submitDate", 1024L);

		columnBitmasks.put("submissionText", 2048L);

		columnBitmasks.put("comment_", 4096L);

		columnBitmasks.put("grade", 8192L);
