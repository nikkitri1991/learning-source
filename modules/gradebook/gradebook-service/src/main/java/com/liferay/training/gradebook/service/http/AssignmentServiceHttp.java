...
public class AssignmentServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getAssignmentsByGroupIdParameterTypes4);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getAssignmentsByKeywordsParameterTypes5);
	...
	public static long getAssignmentsCountByKeywords(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getAssignmentsCountByKeywordsParameterTypes6);
	...
	private static final Class<?>[] _getAssignmentParameterTypes3 =
		new Class[] {long.class};
	private static final Class<?>[] _getAssignmentsByGroupIdParameterTypes4 =
		new Class[] {long.class};
	private static final Class<?>[] _getAssignmentsByKeywordsParameterTypes5 =
		new Class[] {
			long.class, String.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
		_getAssignmentsCountByKeywordsParameterTypes6 = new Class[] {
